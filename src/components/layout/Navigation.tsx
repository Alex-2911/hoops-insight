...
import { Home, TrendingUp, History, Star, Wallet } from 'lucide-react';
import { cn } from '@/lib/utils';

const navItems = [
  { path: '/', label: 'Home', icon: Home },
  { path: '/predictions', label: 'Today\'s Picks', icon: TrendingUp },
  { path: '/history', label: 'Accuracy', icon: History },
  { path: '/shortlist', label: 'Best Bets', icon: Star },
